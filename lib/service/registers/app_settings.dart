...
class AppSettings {
  ...
  static Future<void> openDisplaySettings({
    ...
    await _channel.invokeMethod('display', {
      'asAnotherTask': asAnotherTask,
    });
  }
  ...
  static Future<void> openAppSettings({
    ...
    await _channel.invokeMethod('app_settings', {
      'asAnotherTask': asAnotherTask,
    });
  }
  ...
  static Future<void> openDevelopmentSettings({bool asAnotherTask = false}) async {
    await _channel.invokeMethod('development', {'asAnotherTask': asAnotherTask});
  }

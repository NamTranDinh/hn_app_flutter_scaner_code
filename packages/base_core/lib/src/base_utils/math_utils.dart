...
class MathUtils {
  ...
  ///
  static double round(double value, int decimals) => (value * pow(10, decimals)).round() / pow(10, decimals);

  ///
  /// Generates random between be [min] and [max]
  ///
  static int getRandomNumber({int min = 0, int max = 2 ^ 32}) => min + Random().nextInt(max - min);
